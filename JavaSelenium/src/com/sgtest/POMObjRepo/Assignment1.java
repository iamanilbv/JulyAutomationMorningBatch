...
import com.sgtest.POMObjRepo.Pages;
...
public static WebDriver driver = null;
	...
	public void loginUser(String username, String password, String user)
	{
		try
		{
			Pages.login_UserName(driver).sendKeys(username);
			Pages.login_Password(driver).sendKeys(password);
			Pages.login_LoginButton(driver).click();
			Thread.sleep(5000);
